...
class SellersOrderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('sellers.orders.index' , compact('sizeTypes'));
    }

    public function apiIndex(Request $request)
    {
        $this->authorize('sellers.orders.index');
    ...
    public function create()
    {
        ...
        return view('sellers.orders.create', compact('provinces', 'carriers'));
    }
    ...
    {
        $this->authorize('sellers.orders.view');

        foreach ($request->ids as $id) {
            $orders = Order::paid()->whereIn('id', $request->ids)->get();
        }

        return view('sellers.orders.print-all', compact('orders'));
    }

    public function shipping_status(Order $order, Request $request)
    {
        $this->authorize('sellers.orders.update');
    ...
    public function notCompleted()
    {
        ...
        return view('sellers.orders.not-completed', compact('prices'));
    }

    public function print(Order $order)
    {
        $this->authorize('selllers.orders.view');

        return view('sellers.orders.print', compact('order'));
    }
    ...
    public function shippingForm(Order $order)
    {
        ...
        return view('sellers.orders.shipping-form', compact('order'));
    }

    public function export(Request $request)
    {
        $this->authorize('sellers.orders.export');
    ...
    {
        $this->authorize('sellers.orders.create');
