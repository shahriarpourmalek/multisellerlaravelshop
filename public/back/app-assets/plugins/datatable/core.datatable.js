...
(function($) {
    ...
    $.fn[pluginName].defaults = {
        ...
        layout: {
            ...
            // datatable UI icons
            icons: {
                sort: { asc: 'feather icon-arrow-up', desc: 'feather icon-arrow-down' },
                pagination: {
                    next: 'feather icon-chevron-left',
                    prev: 'feather icon-chevron-right',
                    first: 'feather icon-chevrons-right',
                    last: 'feather icon-chevrons-left',
                    more: 'feather icon-more-horizontal',
                },
        ...
        translate: {
            records: {
                ...
                noRecords: 'چیزی برای نمایش یافت نشد',
            },
            toolbar: {
                pagination: {
                    items: {
                        default: {
                            ...
                            more: 'صفحات بیشتر',
                            input: 'شماره صفحه',
                            select: 'تعداد در صفحه را انتخاب کنید',
                            all: 'همه',
                        },
