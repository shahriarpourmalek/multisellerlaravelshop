    ...
    (function (e) {
        ...
        function n(e, r) {
            ...
            if ('string' == typeof e)
                ...
                if (e.length > 0) {
                    s += '[<ol class="json-array" style="display: none;">';
                ...
                if (a > 0) {
                    s += '{<ul class="json-dict" style="display: none;">';
                    for (var i in e)
        ...
        e.fn.jsonViewer = function (t, r) {
            return (
                ...
                this.each(function () {
                    var s = n(t, r);
                    o(t) &&
                        (s = '<a href class="json-toggle collapsed"></a>' + s),
                        e(this).html(s),
                        e(this).off('click'),
                        ...
                        e(this).on('click', 'a.json-placeholder', function () {
                            return (
                                e(this).siblings('a.json-toggle').click(), !1
                            );
                        }),
                        1 == r.collapsed &&
                            e(this).find('a.json-toggle').click();
                })
            );
        };
    })(jQuery),
