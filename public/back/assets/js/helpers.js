...
function toRoundInt(number, roundingType = 'close', roundingAmount = 0) {
    if (roundingAmount) {
        switch (roundingType) {
            case 'close': {
            ...
            case 'up': {
                number = Math.ceil(number / roundingAmount) * roundingAmount;
                break;
            }
            case 'down': {
                number = Math.floor(number / roundingAmount) * roundingAmount;
                break;
            }
        }
    }
