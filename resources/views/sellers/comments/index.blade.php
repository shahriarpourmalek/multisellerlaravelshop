                                                ...
                                                @foreach ($comments as $comment)
                                                    <tr id="comment-{{ $comment->id }}-tr">
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <button data-comment="{{ $comment->id }}" data-action="{{ route('comments.destroy', ['comment' => $comment]) }}" type="button" class="btn btn-danger mr-1 waves-effect waves-light btn-delete"  data-toggle="modal" data-target="#delete-modal">حذف</button>
                                                        </td>
                                                    </tr>
                                                @endforeach
