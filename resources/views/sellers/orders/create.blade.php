...
@section('content')
            ...
            <div class="content-body">
                <div class="card overflow-hidden">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" data-auto-complete-url="{{ route('sellers.orders.userInfo') }}" id="order-create-form" action="{{ route('orders.store') }}" data-redirect="{{ route('orders.index') }}" method="post">
                                @csrf
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="products-tab-content" role="tabpanel" aria-labelledby="products-tab">
                                            ...
                                            <div class="col-md-8 offset-md-2 text-center mt-2">
                                                <input id="add-product-to-order" data-action="{{ route('sellers.orders.productsList') }}" type="text" placeholder="افزودن محصول" class="form-control">
                                            </div>
                                        </div>
    ...
    @include('sellers.orders.templates.product')

@endsection

@include('sellers.partials.plugins', ['plugins' => ['jquery-ui', 'persian-datepicker', 'jquery.validate']])
