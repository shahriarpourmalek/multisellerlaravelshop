    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <!-- filter start -->
                @include('sellers.orders.partials.filters')
                <!-- filter end -->

                <section id="main-card" class="card">
                    <div class="card-header">
                        <h4 class="card-title">لیست سفارشات</h4>
                        @can('sellers.orders.export')
                        ...
                        <div class="card-body">
                            <div class="mb-2 collapse datatable-actions">
                                <div class="d-flex align-items-center">
                                    ...
                                    <button type="button" id="print-all-btn" data-action="{{ route('sellers.orders.printAllShippingForms') }}" class="btn btn-success mr-2">پرینت برچسب ها</button>
                                    <button type="button" id="print-all-factor-btn" data-action="{{ route('sellers.orders.printAll') }}" class="btn btn-success mr-2">پرینت فاکتور ها</button>
                            ...
                            <div class="datatable datatable-bordered datatable-head-custom" id="orders_datatable" data-action="{{ route('sellers.orders.apiIndex') }}"></div>
                        </div>
                    </div>
                </section>
            </div>
    ...
    <div class="modal fade" id="shiping-status-change" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <form id="multiple-shipping-status-change" action="{{ route('sellers.orders.shippings-status') }}">
    ...
    <div class="modal fade text-left" id="multiple-delete-modal" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="{{ route('sellers.orders.multipleDestroy') }}" id="order-multiple-delete-form">
                        @csrf
                        @method('delete')
     ...
     <div class="modal fade text-left" id="orders-export-modal" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <form id="orders-export-form" action="{{ route('sellers.orders.export') }}">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
