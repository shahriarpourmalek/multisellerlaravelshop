                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="order-values" role="tabpanel" aria-labelledby="value">
                                    @include('sellers.statistics.orders.filter-tabs')

                                    <div id="order-values-chart" class="chart-area" style="min-height: 445px;" data-min-height="445px" data-action="{{ route('sellers.statistics.orderValues') }}"></div>
                                ...
                                <div class="tab-pane fade" id="order-counts" role="tabpanel" aria-labelledby="count">
                                    ...
                                    <div id="order-counts-chart" class="chart-area" style="min-height: 445px;" data-min-height="445px" data-action="{{ route('sellers.statistics.orderCounts') }}"></div>
                                ...
                                <div class="tab-pane fade" id="order-users" role="tabpanel" aria-labelledby="user">
                                    ...
                                    <div id="order-users-chart" class="chart-area" style="min-height: 445px;" data-min-height="445px" data-action="{{ route('sellers.statistics.orderUsers') }}"></div>
                                ...
                                <div class="tab-pane fade" id="order-products" role="tabpanel" aria-labelledby="product">
                                    ...
                                    <div id="order-products-chart" class="chart-area" style="min-height: 445px;" data-min-height="445px" data-action="{{ route('sellers.statistics.orderProducts') }}"></div>
...
@include('sellers.partials.plugins', ['plugins' => ['apexcharts', 'persian-datepicker']])
