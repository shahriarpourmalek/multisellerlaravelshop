                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="view-counts" role="tabpanel" aria-labelledby="value">
                                    ...
                                    <div id="view-counts-chart" class="chart-area" style="min-height: 445px;" data-min-height="445px" data-action="{{ route('sellers.statistics.viewCounts') }}"></div>
                                ...
                                <div class="tab-pane fade" id="viewer-counts" role="tabpanel" aria-labelledby="value">
                                    ...
                                    <div id="viewer-counts-chart" class="chart-area" style="min-height: 445px;" data-min-height="445px" data-action="{{ route('sellers.statistics.viewerCounts') }}"></div>
