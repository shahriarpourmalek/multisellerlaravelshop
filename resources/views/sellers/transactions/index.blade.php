                ...
                <section id="main-card" class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <div class="datatable datatable-bordered datatable-head-custom" id="transactions_datatable" data-action="{{ route('sellers.transactions.apiIndex') }}"></div>
                        </div>
                    </div>
                </section>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="{{ route('sellers.transactions.multipleDestroy') }}" id="transaction-multiple-delete-form">
                        @csrf
                        @method('delete')
...
@include('sellers.partials.plugins', ['plugins' => ['datatable']])
