                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb no-border">
                                    ...
                                    <li class="breadcrumb-item active">  ویرایش پروفایل فروشنده
                                    </li>
                                </ol>
                            </div>
                        </div>
                                ...
                                <div class="col-md-10 offset-md-1">
                                    ...
                                    <div class="media mb-2">
                                        <a class="mr-2 my-25" href="#">
                                            <img id="profile-pic" src="{{ auth('sellers')->user()->imageUrl }}" alt="users avatar" class="users-avatar-shadow rounded" height="90" width="90">
                                        </a>
                                    ...
                                    <form id="profile-form" action="{{ route('sellers.profile.update') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                                        @csrf
                                        @method('put')
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <div class="controls">
                                                            <label>نام</label>
                                                            <input name="seller_name" type="text" class="form-control" placeholder="نام" value="{{ auth('sellers')->user()->seller_name }}" required >
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input name="username" type="text" class="form-control" placeholder="نام کاربری" value="{{ auth('sellers')->user()->username }}" required >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="bio" id="bio" rows="3" class="form-control">{{ auth('sellers')->user()->bio }}</textarea>
                                                </div>
                                            </div>
{{--                                            <div class="col-12">--}}
{{--                                                <div class="custom-control custom-switch custom-control-inline">--}}
{{--                                                    <input type="checkbox" class="custom-control-input" id="subscribe-to-webpush" {{ auth('sellers')->user()->pushSubscriptions()->first() ? 'checked' : '' }}>--}}
