...
<head>
  ...
  <title>لاگ ها</title>
  <link rel="stylesheet" href="{{ asset('back/assets/js/pages/logs/bootstrap.min.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ asset('back/assets/js/pages/logs/dataTables.bootstrap4.min.css') }}">
  <style>
    body {
      padding: 25px;
    }
...
<script src="{{ asset('back/assets/js/pages/logs/jquery-3.2.1.slim.min.js') }}"></script>
<script src="{{ asset('back/assets/js/pages/logs/bootstrap.min.js') }}"></script>

<!-- FontAwesome -->
<script defer src="{{ asset('back/assets/js/pages/logs/all.js') }}"></script>

<!-- Datatables -->
<script type="text/javascript" src="{{ asset('back/assets/js/pages/logs/jquery.dataTables.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('back/assets/js/pages/logs/dataTables.bootstrap4.min.js') }}"></script>
